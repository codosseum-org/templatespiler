...
type TerminalBinding = TerminalBinding' BNFC'Position
data TerminalBinding' a
    = SingleBinding a Ident (Type' a)
    | ParenBinding a (TerminalBinding' a)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable, C.Data, C.Typeable, C.Generic)

type BindingGroup = BindingGroup' BNFC'Position
data BindingGroup' a = BindingGroup a [TerminalBinding' a]
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable, C.Data, C.Typeable, C.Generic)

type BindingOrCombinator = BindingOrCombinator' BNFC'Position
data BindingOrCombinator' a
    = NamedBinding a (TerminalBinding' a)
...
data BindingList' a = BindingList a [BindingListEntry' a]
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable, C.Data, C.Typeable, C.Generic)

type BindingListEntry = BindingListEntry' BNFC'Position
data BindingListEntry' a = BindingListEntry a (TerminalBinding' a)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable, C.Data, C.Typeable, C.Generic)
...
instance HasPosition TerminalBinding where
  hasPosition = \case
    SingleBinding p _ _ -> p
    ParenBinding p _ -> p
...
instance HasPosition BindingListEntry where
  hasPosition = \case
    BindingListEntry p _ -> p
